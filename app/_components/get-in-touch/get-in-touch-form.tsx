...
const ENDPOINT = process.env.NEXT_PUBLIC_GIT_FORM_ENDPOINT;

export default function GetInTouchForm() {
  const [values, setValues] = useState<GitFormValues>({
    name: "",
    mobile: "",
    email: "",
    service: "",
    ...
    <form onSubmit={onSubmit} noValidate>
      ...
      <label htmlFor="git-mobile">
        ...
        <PhoneInput
          ...
          className="w-full mt-2 flex items-stretch rounded-lg border border-gray-light focus-within:border-primary bg-transparent transition duration-200"
          inputClassName="flex-1 p-3 bg-transparent text-white placeholder-white border-0 focus:outline-none"
          inputStyle={{ background: "transparent", color: "white" }}
          countrySelectorStyleProps={{
            buttonClassName:
              "px-3 border-0 bg-transparent text-white focus:outline-none",
            buttonStyle: { background: "white", color: "white" },
          }}
          inputProps={{
            id: "git-mobile",
            name: "mobile",
